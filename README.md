...
Internal cold call assistant for BT Local Business broadband and connectivity. A stepwise decision tree that guides you through a call, from the opening line to booking the specialist meeting.

The mobile assistant is a separate site in its own repository, and the two link to each other:

| Assistant | Repository | Site |
| --- | --- | --- |
| **Broadband and connectivity** (this one) | Sales-Conversation-Assistant | https://nbalabanovic.github.io/Sales-Conversation-Assistant/ |
| **Mobile** (EE battle cards) | [mobile-conversation-assistant](https://github.com/nbalabanovic/mobile-conversation-assistant) | https://nbalabanovic.github.io/mobile-conversation-assistant/ |
